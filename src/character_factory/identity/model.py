...
One model generation lives here: :class:`JointGenerativeIdentity`, a
single joint GENERATIVE model — a semantic-center regressor plus a
conditional rectified flow sampling a residual around it, over one
51-value state (body identity, skeletal proportions, face identity). It
is deliberately tiny: the heavy lifting lives in the frozen text encoder
shared with the texture pipeline.
...
# --------------------------------------------------------------------------
# the joint generative identity model
# --------------------------------------------------------------------------
#
